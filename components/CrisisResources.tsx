    ...
    <Wrapper>
      ...
      {showNote && (
        <p className="text-sm text-mute mb-4 leading-relaxed">
          These are free, confidential services staffed by trained counsellors. The HEAL app is not
          a substitute for professional mental-health care, and is not monitored in real time.{' '}
          <strong>
              ...
              {r.secondary && (
                <div className="text-xs text-mute mt-0.5">
                  ...
                  {r.secondary.startsWith('http') ? (
                    ...
                    <a
                      href={`tel:${r.secondary.replace(/\s|-|\(|\)|\+/g, '')}`}
                      className="underline"
                    >
                      {r.secondary}
                    </a>
