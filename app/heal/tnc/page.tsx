    ...
    <main className="container-narrow py-12 md:py-20">
      ...
      <article className="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-24 prose-headings:font-semibold prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-lg prose-h3:mt-6 prose-h3:mb-2 prose-a:text-coral">
        ...
        <p>
          ...
          the <strong>"Service"</strong>) — you agree to be bound by these Terms. If you do not
          agree to these Terms in their entirety, do not download, install or use the Service and
        ...
        <p>
          ...
          sessions, supported languages and pricing may change without notice. We may discontinue
        ...
        <p>
          The license is conditional on you not breaching any part of Section 6 or any other
        ...
        <ol>
          ...
          <li>
            distribute, sublicense, rent, lease, lend, sell, resell or otherwise commercially
            exploit the App or the Content;
          </li>
          <li>
            remove, alter or obscure any copyright, trademark or other proprietary notice appearing
            in or on the App;
          </li>
          <li>
          ...
          <li>
            use the App to provide clinical, therapeutic, medical, psychiatric, psychological or
            other professional services to any third party;
          </li>
          <li>
          ...
          <li>
            use the App while operating a motor vehicle, heavy machinery, or in any other situation
            in which a momentary lapse of attention could result in death or serious injury.
          </li>
        </ol>
        ...
        <ul>
          ...
          <li>
            the Audio Content, including voice recordings, narration scripts and musical
            compositions;
          </li>
          <li>
          ...
          <li>
            any clinical protocols, scripts and methodologies underlying the Audio Content,
            including those developed in collaboration with clinical consultants.
          </li>
        </ul>
        <p>
          No rights are granted to you except the limited license expressly set out in Section 5.
          You agree not to register, attempt to register, or assist any third party to register any
          trademark, domain name, copyright or other intellectual property right that incorporates
          or is confusingly similar to any mark, name or Content of the Company.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            sublicensable license to use, reproduce, modify, distribute, display and create
            derivative works of such content in connection with operating and improving the Service;
          </li>
          <li>
        ...
        <p className="lead">
          <strong>
            ...
            disease, disorder, or health condition. The Audio Content is for general wellness,
            relaxation and stress-reduction purposes only.
          </strong>
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            the European Medicines Agency (EMA), the Health Sciences Authority of Singapore (HSA),
            the Indonesian Food and Drug Authority (BPOM), or any other regulatory body for the
            treatment of any medical condition.
          </li>
          <li>
            <strong>Is not a substitute for</strong> medication, psychotherapy, counselling or other
            forms of professional care. If a healthcare professional has prescribed any treatment
            for you, do not discontinue that treatment in reliance on HEAL.
          </li>
        </ol>
        ...
        <ul>
          <li>
            ...
            or operating any vehicle or machinery. Use only when stationary and able to give your
            full attention to the audio.
          </li>
          <li>
            <strong>Hearing damage:</strong> Listening at high volumes for extended periods can
            cause permanent hearing loss. Begin playback at the lowest comfortable volume. If you
            experience ringing, buzzing, or discomfort, lower the volume or discontinue use and
            consult a hearing specialist.
          </li>
          <li>
            <strong>Seizure precautions:</strong> Although HEAL does not contain flashing lights or
            rapid visual stimuli, if you have ever experienced a seizure, loss of awareness, or
            other neurological symptoms triggered by audio or sensory stimuli, consult a physician
            before use.
          </li>
          <li>
          ...
          <li>
            <strong>Sleep latency:</strong> HEAL sessions are designed to support sleep onset, not
            to treat insomnia as a medical condition. Persistent difficulty falling asleep or
            staying asleep may indicate an underlying sleep disorder; consult a physician.
          </li>
          <li>
            <strong>Medication interactions:</strong> If you are taking any medication affecting
            mood, sleep, attention, heart rate or blood pressure, consult your prescribing physician
            before combining such medication with relaxation audio.
          </li>
        </ul>

        <h3>9.2 No Guarantees</h3>
        <p>
          We do not guarantee that HEAL will produce any particular result. Individual outcomes
          vary. Testimonials presented in the App, on our website or in marketing materials reflect
          the experience of individual users and are not representative of all users; they do not
        ...
        <p>
          ...
          contact one of the free, confidential services listed below — or your local emergency
          number (for example 911 in the U.S., 999 in the U.K. and Singapore, 112 in the EU,
          110/118/112 in Indonesia, 995 in Singapore).
        </p>
        ...
        <p>
          HEAL may be offered on a free basis, as a one-time purchase, or as a recurring
        ...
        <ol>
          ...
          <li>
            ...
            <ul>
              <li>
                <strong>iOS / App Store:</strong> Settings → Apple ID → Subscriptions → HEAL →
          ...
          <li>
            ...
            next period after we have notified you in accordance with Section 14.
          </li>
          <li>
          ...
          <li>
            ...
            Store purchases are handled by Apple — see Section 13 below.
          </li>
          <li>
          ...
          <li>
            ...
            Store, is governed by the Store's family-sharing policies. You are responsible for who
            in your family group accesses the App.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            ...
            cancellation-and-resubscription cycles, or use of multiple Stores by the same
            individual).
          </li>
        </ol>
        ...
        <ul>
          <li>
            ...
            go to reportaproblem.apple.com and follow Apple's instructions. We are unable to
            override Apple's decision.
          </li>
          <li>
            <strong>Google Play Store:</strong> Google controls refund decisions. To request a
            refund, open Google Play → your profile icon → Payments & subscriptions → Budget & order
            history → select the order → Request refund. We are unable to override Google's
            decision.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          us at the address listed in Section 31 and explain why the Service did not meet your
          reasonable expectations. We may ask you to describe the issue and may suggest non-monetary
          remedies first.
        </p>
        <p>
        ...
        <p>
          ...
          Service will be accurate or reliable, that any errors will be corrected, or that the App
        ...
        <ol>
          ...
          <li>
            any loss of profits, revenue, business, goodwill, anticipated savings, data, use,
        ...
        <p>
          ...
          consultants from and against any and all claims, damages, obligations, losses,
        ...
        <ul>
          <li>
            does <strong>not</strong> create a clinician–patient, therapist–client, doctor–patient
            or any other professional relationship between you and the Company, its employees or its
            consultants;
          </li>
          <li>
        ...
        <p>
          ...
          because of something you have heard in HEAL.
        </p>
        ...
        <ul>
          ...
          <li>
            The Company does not use your listening behaviour to train AI/ML models, except where
        ...
        <p>
          ...
          of Singapore law as governing law (for example, any EU member state that requires the
        ...
        <p>
          ...
          at the address in Section 31 and give us 30 days to resolve the issue informally. Most
          concerns are resolved this way.
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            you waive any right to claim any damages not expressly identified in Section 17.
          </li>
          <li>
