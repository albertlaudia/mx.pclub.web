...
export default function OnepercTermsPage() {
  return (
    <PlainLegalPage
      documentTitle="1perc — Terms and Conditions"
      version={VERSION}
      lastUpdated={LAST_UPDATED}
      otherDoc={{ label: '1perc — Privacy Policy', href: '/1perc/policies' }}
      sections={SECTIONS}
    >
      ...
      <p>
        ...
        1perc mobile application (the <strong>"App"</strong> or <strong>"1perc"</strong>).
      </p>
      <p>
        By downloading, installing, accessing or using 1perc — including any of its book summaries,
        audio narrations, written text, or related services made available by the Company
        (collectively, the <strong>"Service"</strong>) — you agree to be bound by these Terms. If
        you do not agree to these Terms in their entirety, do not download, install or use the
        Service and delete the App from your device.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>"Source Book"</strong> means any book, essay, article, podcast transcript, speech
          or other published work summarised in the App.
        </li>
        <li>
          <strong>"Summary"</strong> means each condensed analysis, outline, key-point list, audio
          narration or other derivative work created by the Company in respect of a Source Book and
      ...
      <p>
        1perc is intended to <strong>supplement</strong>, not <strong>replace</strong>, reading the
        Source Book in full. We encourage users to read the books they find valuable in their
        entirety.
      </p>
      <p>
        1perc is currently in <strong>public beta</strong>. Features, summary count, audio narration
        availability, supported languages and pricing may change without notice. We may discontinue
      ...
      <ul>
        ...
        <li>
          quote brief excerpts of a Summary in your own original writing (for example, a book review
          or social media post), provided that you (a) attribute the quote to the Source Book's
          title and author and to 1perc, (b) do not reproduce more than 100 words from any single
          Summary, and (c) do not use the quote in any advertising or commercial promotion.
        </li>
      </ul>
      <p>
        The license is conditional on you not breaching any part of Section 7 or any other provision
      ...
      <ol>
        <li>
          reproduce, redistribute, republish, retransmit, sell, sublicense, rent, lease or lend any
          Summary or other Content, in whole or in part, in any form or by any means (including but
          not limited to: screenshots, audio recordings, OCR, screen-capture, dictation, copy-paste
          at scale, or use of automated bots/scrapers);
        </li>
        <li>
          make summaries available on any third-party platform (including Telegram channels, Discord
          servers, archive sites, file-sharing services, or competing book-summary services);
        </li>
        <li>
          use the App or Content for commercial purposes, including paid newsletters, paid courses,
          or commercial book-review services, without our prior written consent;
        </li>
        <li>
        ...
        <li>
          ...
          appearing in or on the App or the Content;
        </li>
        <li>use the App in any unlawful manner or in violation of any applicable law;</li>
        <li>
          scrape, crawl, archive or otherwise extract data from the App using automated means (other
          than ordinary search-engine indexing of public web pages, which is permitted);
        </li>
        <li>
        ...
        <li>
          use the App while operating a vehicle or in any other situation where a momentary lapse of
          attention could cause harm (we recommend using the audio only when you can give it your
          full attention);
        </li>
        <li>
      ...
      <p>
        ...
        property of the Company, our licensors, and (where applicable) the authors and publishers of
        Source Books. We and our licensors own all right, title and interest — including all
      ...
      <ul>
        ...
        <li>the audio recordings, including voice performances by talent we engage and produce;</li>
        <li>
      ...
      <ol>
        ...
        <li>
          <strong>Attribution.</strong> Every Summary prominently displays the Source Book's title,
          author, year of publication, and a link to purchase the Source Book from the publisher's
          preferred retailer (typically Amazon, Apple Books, or the publisher's own store).
        </li>
        <li>
        ...
        <li>
          <strong>Removal on request.</strong> If an author or rights holder requests that a Summary
          be removed, we will do so promptly. See §20.
        </li>
        <li>
          ...
          Canada, the United Kingdom, Singapore, Australia, and the EU. Where the law of the User's
          jurisdiction provides broader protection, we rely on that broader protection.
        </li>
        <li>
          <strong>Licensing where possible.</strong> For Source Books where a license is required or
          available (including books published under Creative Commons licenses whose terms permit
          summarisation), we obtain such licences on commercially reasonable terms.
        </li>
      </ol>
      <p>
      ...
      <p>
        1perc is a book-summary app. Books discussed in 1perc may include topics that overlap with:
      </p>
      <ul>
      ...
      <p>
        If a Source Book discusses a topic that requires professional advice (for example, a book on
        managing diabetes), you must consult a qualified professional before acting on any
      ...
      <p>
        ...
        own in-house production). Voice-talent agreements are concluded directly between the Company
        and the talent or the talent's agency.
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          new Content. Past narrations may continue to be available.
        </li>
        <li>
      ...
      <p>
        1perc Pro Tier is offered as a recurring Subscription through the Stores. If you purchase a
        Subscription:
      </p>
      <ol>
        <li>
        ...
        <li>
          ...
          <ul>
            <li>
              <strong>iOS / App Store:</strong> Settings → Apple ID → Subscriptions → 1perc → Cancel
        ...
        <li>
          ...
          period after we have notified you in accordance with §15.
        </li>
        <li>
        ...
        <li>
          ...
          purchases are handled by Apple — see §14.
        </li>
        <li>
        ...
        <li>
          <strong>Promo codes.</strong> Promotional codes (e.g. for beta testers or journalists) are
          issued at the Company's sole discretion, may be time-limited, and are non-transferable and
          non-refundable.
        </li>
      </ol>
      ...
      <ul>
        ...
        <li>
          ...
          open Google Play → your profile icon → Payments &amp; subscriptions → Budget &amp; order
          history → select the order → Request refund. We are unable to override Google's decision.
        </li>
      </ul>
      <p>
      ...
      <p>
        ...
        at the address listed in §31 and explain why the Service did not meet your reasonable
        expectations. We may ask you to describe the issue and may suggest non-monetary remedies
        first.
      </p>
      <p>
        <strong>Free Tier cancellations.</strong> If you have not paid for the Service and have made
      ...
      <ul>
        ...
        <li>
          remove or replace any Summary in the catalogue, including where a Source Book's publisher
          or author has requested removal;
        </li>
        <li>
      ...
      <p>
        ...
        ends immediately. Sections that by their nature should survive termination (including those
        governing intellectual property, disclaimers, limitation of liability, indemnification,
        dispute resolution and governing law) will survive.
      </p>
      ...
      <ol>
        ...
        <li>
          ...
          or applicability of any Summary or any opinion, recommendation or statement in a Summary.
        </li>
      </ol>
      <p>
        <strong>
      ...
      <p>
        If you are an author, publisher or other rights holder and believe that a Summary in the App
        infringes your copyright, please send a written notice to the address in §31 that includes:
      </p>
      <ol>
        ...
        <li>
          a statement that you have a good-faith belief that the Summary is not authorized by you as
          the rights holder, your agent, or the law;
        </li>
        <li>
      ...
      <p>
        1perc uses human editors as the primary authors of Summaries. We may, at our discretion, use
        AI tools (such as large language models) as <strong>editorial assistants</strong> for tasks
        like outline generation, grammar review, and translation. All Summaries are reviewed and
      ...
      <ul>
        <li>the synthesised voice is licensed from a third-party provider or produced in-house;</li>
        <li>
      ...
      <p>
        ...
        Singapore law as governing law may rely on the mandatory consumer-protection laws of that
        country.
      </p>
      ...
      <p>
        ...
        the address in §31 and give us 30 days to resolve the issue informally. Most concerns are
        resolved this way.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="/1perc/policy">/1perc/policies</a>) and any policies or notices referenced within
      ...
      <ul>
        ...
        <li>
          ...
          you give express consent and acknowledge the loss of withdrawal right, as set out in §14
          above.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          waive any right to claim any damages not expressly identified in §18.
        </li>
        <li>
