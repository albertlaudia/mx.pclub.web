    ...
    <main className="container-narrow py-12 md:py-20">
      <header className="mb-12">
        ...
        <p className="text-sm text-mute mt-2">
          ...
          <Link href="/resonate/terms" className="text-coral underline">
            See Resonate — Terms and Conditions
          </Link>
          .
        </p>
      </header>
      ...
      >
        ...
        <ul className="space-y-2 text-sm">
          <li>
            ✅ Your practice history, tunings, and lesson progress are stored{' '}
            <strong>locally on your device</strong> by default. We do not upload them.
          </li>
          <li>
            ✅ <strong>Microphone data is processed on-device only</strong> — never recorded,
      ...
      <article className="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-24 prose-headings:font-semibold prose-h2:text-2xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-lg prose-h3:mt-6 prose-h3:mb-2 prose-a:text-coral">
        ...
        <ul>
          ...
          <li>
            <strong>What we do not collect:</strong> Your practice history, tunings, lesson
            progress, microphone audio, location, contacts, photos, biometrics, advertising IDs, or
        ...
        <p>
          This Policy describes the personal data the Company collects from Users through the
          Resonate App and related services (the <strong>"Service"</strong>); how the Company uses
          that data; with whom the Company shares that data; how long the Company keeps that data;
          the rights Users have over their data; and how Users can exercise those rights.
        </p>
        ...
        <ol>
          ...
          <li>
            <strong>Music-licensing intermediaries.</strong> If you play a track through a
            third-party (e.g. backing-track provider), the relevant intermediary may receive a
            request. The intermediary's own privacy policy applies.
          </li>
          <li>
        ...
        <p>
          ...
          §13. Our legal bases for processing are set out in §7. We are required to lodge the
        ...
        <p>
          ...
          advertising. We do not collect SPI in the first place. Other U.S. states have similar
        ...
        <p>
          ...
          may complain to the Office of the Privacy Commissioner of Canada or the Commission d'accès
        ...
        <p>
          ...
          2022 tentang Pelindungan Data Pribadi, "UU PDP") applies. We will appoint a local
          representative as required by the UU PDP before marketing the Service in Indonesia.
        </p>
        ...
        <p>
          ...
          authorities is provided in our HEAL Privacy Policy §26, which is incorporated by
          reference).
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>
              Not using audio lessons, chord charts, transcriptions, or backing tracks to train
              AI/ML models.
            </strong>{' '}
            You may not use any Content to train, fine-tune, evaluate or clone any voice,
            instrument, or music-generation system (see{' '}
            <Link href="/resonate/terms" className="text-coral underline">
              Resonate Terms §10
            </Link>
            ).
