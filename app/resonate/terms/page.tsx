...
export default function ResonateTermsPage() {
  return (
    <PlainLegalPage
      documentTitle="Resonate — Terms and Conditions"
      version={VERSION}
      lastUpdated={LAST_UPDATED}
      otherDoc={{ label: 'Resonate — Privacy Policy', href: '/resonate/policy' }}
      sections={SECTIONS}
    >
      ...
      <p>
        ...
        Resonate mobile application (the <strong>"App"</strong> or <strong>"Resonate"</strong>
        ).
      </p>
      <p>
        By downloading, installing, accessing or using Resonate — including the tuner, the music
        library, the chord catalogue, the lesson videos, the backing tracks, or any related services
        (collectively, the <strong>"Service"</strong>) — you agree to be bound by these Terms. If
        you do not agree, do not download, install or use the Service.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>"Free Tier"</strong> means the limited free tier of the Service (e.g. basic tuner
          only).
        </li>
        <li>
          <strong>"Pro Tier"</strong> means the paid tier that includes unlimited access to advanced
          tunings, the full chord and lesson library, backing tracks, and offline downloads.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          use the App and access the Content solely for your personal, non-commercial music-practice
          use;
        </li>
        <li>stream or download Content for offline use within the App;</li>
        <li>
          quote brief excerpts of chord progressions or tablature in your own original compositions
          or teaching materials, provided that you (a) attribute the source to the original creator
          and Resonate, and (b) do not reproduce more than 8 bars of a copyrighted work or more than
          100 words of lyrics.
        </li>
      </ul>
      ...
      <ol>
        ...
        <li>
          ...
          distribution without obtaining the necessary licences from the relevant collecting society
          (ASCAP/BMI/SESAC in the U.S., PRS/MCPS in the U.K., GEMA in Germany, JASRAC in Japan, APRA
          AMCOS in Australia, MACP in Malaysia, etc.);
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          (typically CC BY 4.0, CC BY-SA 4.0, or CC0). Attribution is provided in the App and in the
          metadata for each piece of Content. You may re-use such Content under the terms of the
          relevant CC licence.
        </li>
        <li>
          <strong>Directly licensed Content</strong> — Licensed from the rights-holder under a
          specific written agreement. Use is restricted to the personal practice purposes described
          in §6.
        </li>
        <li>
          <strong>Public-domain Content</strong> — Where the underlying composition is in the public
          domain in your jurisdiction, the recording and any added arrangements may still be
          copyrighted by the Company or by a third party.
        </li>
      </ul>
      <p>
      ...
      <p>
        Resonate's music library is curated carefully. Chord progressions, voicings, and fingerings
        are based on common-practice musical conventions. Tablature and transcriptions are either:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          lyrics in the <strong>U.S. only</strong> that are unambiguously in the public domain under
          U.S. copyright law (17 U.S.C. § 304).
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>Voice-synthesis providers</strong> for fully synthesised voices that are not based
          on a real person's biometric data without consent.
        </li>
      </ul>
      <p>
        <strong>You may not</strong> use any Resonate audio (including lessons, intros, narrations,
        or backing-track performances) to train, fine-tune, evaluate, or clone any AI/ML model,
        music-generation system, or voice/instrument-synthesis system. This includes (without
        limitation) training a model that produces chord charts, transcriptions, or music in the
        style of Resonate Content.
      </p>

      <h3>10.2 User contributions (in future versions)</h3>
      <p>
        If we release a feature that lets you submit your own chord progressions, transcriptions, or
        recordings ("<strong>User Contributions</strong>"), you must first agree to a Contributor
        Agreement that assigns or licenses your User Contributions to the Company. Until then, the
        App does not accept User Contributions.
      </p>
      ...
      <p>
        ...
        signal <strong>in real time, on your Device</strong>, to detect the fundamental frequency of
        the played note. Specifically:
      </p>
      <ol>
        <li>
      ...
      <p>
        ...
        playing (or that of a consenting third party in your private space). The App is not designed
        to capture or analyse conversations.
      </p>

      <h2 id="subscriptions">12. Subscriptions, Auto-Renewal &amp; Billing</h2>
      <p>
        Resonate is offered under a Free Tier (limited features) and a paid Pro Subscription. If you
      ...
      <p>
        ...
        refund of up to 30 days from the original purchase date if you contact us at the address in
        §29 and explain why the Service did not meet your reasonable expectations.
      </p>
      ...
      <p>
        <strong>
          ...
          FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, QUIET ENJOYMENT, ACCURACY, OR THAT USE
          WILL BE UNINTERRUPTED OR ERROR-FREE.
        </strong>
      </p>
      <p>
        We do not warrant that the tuner will detect any specific instrument, tuning, or pitch to
        within any specific accuracy threshold. Tuning accuracy depends on the Device's microphone,
        ambient noise, instrument pickup, and pitch-detection algorithm. We do our best but cannot
        guarantee ±0.1 cent accuracy on any Device.
      </p>
      ...
      <p>
        <strong>
          ...
          OR ANY DAMAGES RESULTING FROM YOUR ACCESS TO OR USE OF (OR INABILITY TO ACCESS OR USE) THE
          SERVICE.
        </strong>
      </p>
      <p>
        <strong>
          ...
          SUPPLIERS WILL NOT EXCEED THE GREATER OF (A) THE TOTAL FEES PAID BY YOU IN THE TWELVE (12)
          MONTHS PRECEDING THE EVENT GIVING RISE TO THE CLAIM, OR (B) ONE HUNDRED U.S. DOLLARS (USD
          100).
        </strong>
      </p>
      <p>
      ...
      <p>
        <strong>Binding arbitration.</strong> Any dispute arising out of or relating to these Terms
        will be determined by binding arbitration administered by the Singapore International
        Arbitration Centre (SIAC) under its then-current Arbitration Rules, by a single arbitrator.
        The seat of arbitration will be Singapore. The language of arbitration will be English.
      </p>
      <p>
        <strong>Exceptions.</strong> Either party may bring (a) an action for injunctive relief in a
        court of competent jurisdiction to prevent (or stop) an actual or threatened infringement of
        intellectual property rights, or (b) a small-claims action within the scope of that court's
      ...
      <p>
        ...
        <a href="/resonate/policy" className="text-coral underline">
          Resonate Privacy Policy
        </a>{' '}
        and any policies referenced within them, constitute the entire agreement between you and the
        Company with respect to the Service.
      </p>
