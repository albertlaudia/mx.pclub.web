...
export default function RiseupPolicyPage() {
  return (
    <PlainLegalPage
      documentTitle="Riseup — Privacy Policy"
      version={VERSION}
      lastUpdated={LAST_UPDATED}
      otherDoc={{ label: 'Riseup — Terms and Conditions', href: '/riseup/terms' }}
      sections={SECTIONS}
    >
      ...
      <ul>
        ...
        <li>
          ...
          location, contacts, photos, microphone audio, biometrics, advertising IDs, or any "special
      ...
      <p>
        ...
        jurisdictions. Until then, contact the Company directly at the address above.
      </p>
      ...
      <ul>
        <li>
          <strong>App version, device model, OS version, locale.</strong> Reason: deliver a routine
          in your language and to a compatible format.
        </li>
        <li>
      ...
      <p>
        By default, <strong>everything you do in Riseup stays on your device</strong>. This includes
        your habits, journal entries, streak counters, downloaded sessions, and preferences. This
        data is stored in an encrypted SQLite database on your device.{' '}
        <strong>
      ...
      <p>
        Riseup is not directed to children under the age thresholds in §4 of our Terms. If we learn
        that we have inadvertently collected personal data from a child below the threshold, we will
      ...
      <p>
        ...
        §12. Our legal bases for processing are set out in §6. We are required to lodge the contact
      ...
      <p>
        ...
        We do not collect SPI in the first place. Other U.S. states (Colorado, Connecticut,
        Delaware, Indiana, Iowa, Kentucky, Maryland, Minnesota, Montana, Nebraska, New Hampshire,
        New Jersey, Oregon, Rhode Island, Tennessee, Texas, Utah, Virginia, Washington) have similar
        laws; we extend those rights to all U.S. residents regardless of state.
      </p>
      ...
      <p>
        ...
        implementing governance over the personal information of Quebec residents. You may complain
        to the Office of the Privacy Commissioner of Canada or the Commission d'accès à
      ...
      <p>
        ...
        tentang Pelindungan Data Pribadi, "UU PDP") applies. You have the right to access, correct,
        delete your personal data, withdraw consent, object to automated decision-making, and lodge
        a complaint. We will appoint a local representative as required by the UU PDP before
        marketing the Service in Indonesia.
      </p>
      ...
      <p>
        If you are in Thailand, the Personal Data Protection Act B.E. 2562 (2019) applies. You have
        rights similar to those under the GDPR.
      </p>
      ...
      <p>
        ...
        may complain to the Personal Information Protection Commission.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="/riseup/terms" className="text-coral underline">
            Riseup Terms §10
          </a>
          ).
        </li>
