...
export default function OnepercPrivacyPage() {
  return (
    <PlainLegalPage
      documentTitle="1perc — Privacy Policy"
      version={VERSION}
      lastUpdated={LAST_UPDATED}
      otherDoc={{ label: '1perc — Terms and Conditions', href: '/1perc/terms' }}
      sections={SECTIONS}
    >
      ...
      <ul>
        ...
        <li>
          ...
          notes, your listening history, your location, your contacts, your photos, your microphone
          audio (beyond voice-input features that you explicitly enable), your biometrics, your
          advertising ID.
        </li>
        <li>
      ...
      <p>
        ...
        jurisdictions. The representative's details will be added here and notified to Users by
        email and in-App. Until then, contact the Company directly at the address above.
      </p>
      <p>
        <strong>Local-counsel review.</strong> This policy must be reviewed by a licensed attorney
        in the user's country of residence before being relied upon to defend any claim. Until then,
        treat this document as an internal policy, not legal advice.
      </p>
      ...
      <ul>
        ...
        <li>
          Data you submit to third-party retailers when buying a Source Book — those are governed by
      ...
      <p>
        We believe in collecting the minimum data necessary to deliver the Service. The table below
        summarises what we collect and what we deliberately don't.
      </p>

      <h3>4.1 What we collect (with reason)</h3>
      <ul>
        <li>
          <strong>App version, device model, OS version, locale.</strong> Reason: deliver a Summary
          in your language and to a compatible format. Stored locally; we see aggregated counts
          only.
        </li>
        <li>
          <strong>Subscription status (masked receipt from the Store).</strong> Reason: know whether
          you have access to Pro-tier Summaries. The receipt is delivered by Apple or Google and
          contains no card details.
        </li>
        <li>
          <strong>
            Aggregated crash logs (with your explicit consent in Settings → "Help us fix bugs").
          </strong>{' '}
          Reason: diagnose and fix crashes. Logs are stripped of identifiers before submission. Off
          by default.
        </li>
        <li>
        ...
        <li>
          <strong>Newsletter signup email (if you submit it via positiveness.club).</strong> Reason:
          deliver the newsletter. You can unsubscribe via the link in every email or via
          /unsubscribe.
        </li>
      </ul>
      ...
      <ul>
        <li>
          Your name, address, phone number, or date of birth (unless you provide it to us in support
          correspondence).
        </li>
        <li>
          Your reading history, completion percentages, or list of completed books (kept on-device).
        </li>
      ...
      <p>
        This data is used only to improve which Summaries we recommend and how we pace them. You can
        revoke this consent at any time and we will stop collecting further data.
      </p>

      <h2 id="where">5. Where Your Data Lives (Local-First)</h2>
      <p>
        By default, <strong>everything you do in 1perc stays on your device</strong>. This includes:
      </p>
      <ul>
      ...
      <p>We may offer an optional cloud-sync feature in a future version of the App. When we do:</p>
      <ul>
        <li>
          Sync will be <strong>end-to-end encrypted</strong> using libsodium XChaCha20-Poly1305 with
          a key derived from your password and stored only on your devices.
        </li>
        <li>
          The Company will have{' '}
          <strong>no technical ability to read your highlights, notes, or reading progress</strong>.
        </li>
      ...
      <ul>
        ...
        <li>
          ...
          Service, prevent abuse, and respond to legal requests. We balance our legitimate interest
          against your rights and freedoms.
        </li>
        <li>
          <strong>Consent</strong> (Art. 6(1)(a)) — for optional features like "Share listening
          stats", for storing cookies, and for processing any sensitive personal data you choose to
          share with us in support correspondence.
        </li>
        <li>
      ...
      <p>
        ...
        have inadvertently collected personal data from a child below the threshold, we will delete
        it as soon as possible.
      </p>
      <p>
        If you believe we have collected data from a child below the applicable age, please contact
        us at <a href="mailto:privacy@positiveness.club">privacy@positiveness.club</a> and we will
      ...
      <ol>
        <li>
          ...
          operator of the Store through which you purchased your Subscription. Apple/Google's use of
          your data is governed by their privacy policies.
        </li>
        <li>
        ...
        <li>
          <strong>Email infrastructure providers</strong> (currently Resend Inc., based in the U.S.)
          for transactional emails (e.g. support replies, opt-in confirmations). Used only when you
          submit your email to us.
        </li>
        <li>
        ...
        <li>
          ...
          only for audio rendering at synthesis time; we do not transmit your personal data to them.
        </li>
        <li>
      ...
      <p>
        Where data is stored on your device, it never leaves your jurisdiction in the normal course.
        Cloud-sync (opt-in) routes through the nearest edge location.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          years for tax/audit (where required by law).
        </li>
        <li>
        ...
        <li>
          <strong>Listening stats (opt-in):</strong> Up to 24 months in aggregate form, then deleted
          or fully anonymised.
        </li>
        <li>
          <strong>Newsletter signup:</strong> Until you unsubscribe, plus a 30-day grace period for
      ...
      <ul>
        ...
        <li>
          ...
          authorised staff can access production data, and only for specific purposes (responding to
          your support request, fixing a crash, processing a deletion).
        </li>
        <li>
        ...
        <li>
          ...
          affected Users and relevant regulators of any material breach within 72 hours of discovery
      ...
      <ul>
        ...
        <li>
          <strong>Right to object.</strong> Object to processing based on legitimate interest or for
          direct marketing.
        </li>
        <li>
      ...
      <p>
        If you are in the European Economic Area (EEA), the United Kingdom, or Switzerland, you have
        the rights set out in §12. Our legal bases for processing are set out in §6.
      </p>
      <p>
      ...
      <p>
        ...
        automated processing that have legal or similarly significant effects on you (Art. 22 GDPR).
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          reasonable steps to ensure the recipient handles it in accordance with the APPs (see §9).
        </li>
        <li>
      ...
      <p>
        ...
        tentang Pelindungan Data Pribadi, "UU PDP") applies. You have the right to:
      </p>
      <ul>
      ...
      <p>
        If you are in Thailand, the Personal Data Protection Act B.E. 2562 (2019) ("PDPA Thailand")
        applies. You have rights similar to those under the GDPR, including the right to withdraw
        consent and to lodge a complaint with the Personal Data Protection Committee (PDPC).
      </p>
      ...
      <p>
        If you are in Japan, the Act on the Protection of Personal Information ("APPI") applies. You
        have the right to request disclosure, correction, suspension of use, and deletion of
      ...
      <p>
        ...
        it comes into force. You have rights to access, correction, erasure, grievance redressal,
        and the right to nominate another individual to exercise your rights in the event of your
        death or incapacity.
      </p>
      ...
      <ul>
        ...
        <li>where required by law, request your renewed consent before the change takes effect.</li>
      </ul>
      <p>
        Where the change is required by law (for example, to comply with a new statute), the change
      ...
      <ul>
        <li>
          ...
          listening history, and personal preferences are not transmitted to any model provider for
          training.
        </li>
        <li>
        ...
        <li>
          <strong>Not using audio narration to clone voices.</strong> You may not use any Content to
          train, fine-tune, evaluate or clone any voice (see /1perc/tnc §7 and §11).
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <strong>ElevenLabs / PlayHT (or in-house)</strong> — Voice synthesis for audio narration.
      ...
      <p>
        See the 1perc Terms and Conditions (<a href="/1perc/tnc">/1perc/tnc</a>) for the legal terms
