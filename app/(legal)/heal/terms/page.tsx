...
export default function HealTermsPage() {
  return (
    <PlainLegalPage
      ...
      otherDoc={{ label: 'HEAL — Privacy Policy', href: '/heal/policy' }}
      sections={SECTIONS}
    >
      ...
      <p>
        ...
        you and <strong>positiveness.club Pte Ltd</strong> (the <strong>"Company"</strong>,
        <strong>"we"</strong>, <strong>"us"</strong> or <strong>"our"</strong>), the operator of the
        HEAL mobile application (the <strong>"App"</strong> or <strong>"HEAL"</strong>).
      </p>
      <p>
        By downloading, installing, accessing or using HEAL — including any of its guided audio,
        breathwork sessions, mood-tracking, journaling features, or related services made available
        by the Company (collectively, the <strong>"Service"</strong>) — you agree to be bound by
        these Terms. If you do not agree to these Terms in their entirety, do not download, install
        or use the Service and delete the App from your device.
      </p>
      <p>
      ...
      <ul>
        <li>
          ...
          patches, fixes, translations and localizations.
        </li>
        <li>
        ...
        <li>
          <strong>"Emergency"</strong> means an imminent risk of harm to yourself or another person,
          including but not limited to suicidal ideation, self-harm, harm to others, or acute
          medical crisis.
        </li>
        <li>
          <strong>"Store"</strong> means the Apple App Store (operated by Apple Inc.) or the Google
          Play Store (operated by Google LLC) through which the App is distributed.
        </li>
        <li>
      ...
      <p>
        HEAL is designed for adults. Users under 18 should only use the Service with the involvement
        of a parent or legal guardian. If you are in active mental-health crisis or have a diagnosis
        of a severe mental-health condition (e.g. schizophrenia, bipolar I disorder, severe PTSD,
        active eating disorder, active substance-use disorder), please consult a clinician before
        using HEAL.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          quote to HEAL and the original creator, (b) do not reproduce more than 100 words, and (c)
          do not use the quote in advertising.
        </li>
      </ul>
      ...
      <ol>
        <li>
          use HEAL during an Emergency — call your local emergency number (e.g. 911, 999, 112, 119)
          or a crisis hotline (§9) instead;
        </li>
        ...
        <li>remove or alter any copyright, trademark, attribution or other proprietary notice;</li>
        ...
        <li>
          use the App in a way that interferes with safety-critical systems (e.g. while piloting, or
      ...
      <p>
        The Service, the App, the audio Content, the transcripts, the brand and trade dress are and
        will remain the exclusive property of the Company and our licensors (including voice talent,
        script writers, sound designers, and music licensors). No rights are granted to you except
        the limited license expressly set out in §5.
      </p>
      ...
      <ol>
        <li>
          HEAL is <strong>not a medical device</strong> within the meaning of the U.S. Federal Food,
          Drug, and Cosmetic Act, the EU Medical Device Regulation (MDR 2017/745), or any analogous
          law.
        </li>
        <li>
          HEAL is <strong>not a clinical service</strong>. The Company is{' '}
          <strong>not a HIPAA covered entity</strong>, <strong>not a Business Associate</strong> of
          any HIPAA covered entity, and{' '}
          <strong>
        ...
        <li>
          ...
          between you and the Company, or between you and any individual contributor (script writer,
          voice talent, sound designer, advisor) by your use of HEAL.
        </li>
        <li>
          The Content is for <strong>general educational and self-care purposes only</strong>. It is
          not intended to diagnose, treat, cure, or prevent any disease or condition, and is not a
        ...
        <li>
          If you think you may have a medical or mental-health emergency, call your local emergency
      ...
      <p>
        If you are in crisis, in immediate danger, or having thoughts of harming yourself or others:
      </p>
      <ol>
        <li>
        ...
        <li>
          <strong>Contact a crisis hotline.</strong> The Company publishes a list of crisis hotlines
          for 24 jurisdictions in the App's Resources section, in the{' '}
          <a href="/heal/policy" className="text-coral underline">
            HEAL Privacy Policy
          </a>
          , and on our website at{' '}
          <a href="/apps/heal" className="text-coral underline">
      ...
      <p>
        HEAL is not a crisis service, and the Company does not monitor the App in real time. We will
        not see your journal entries, mood logs, or distress signals, and we will not contact
        emergency services on your behalf.
      </p>

      <h2 id="noadvice">10. No Professional Advice</h2>
      <p>
        Audio sessions, transcripts, and educational content within HEAL are written and produced by
        qualified professionals. They reflect the authors' professional opinions and are not a
        substitute for:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          <strong>Third-party voice talent</strong> through agencies or platforms (e.g. Voices.com,
          Fiverr);
        </li>
        <li>
      ...
      <p>
        Voice-talent agreements are concluded directly between the Company and the talent or agency.
        Voice talent retain rights of attribution and may request the removal of their voice from
        new Content.
      </p>
      <p>
        <strong>You may not</strong> use any HEAL audio to train, fine-tune, evaluate, or clone any
        AI/ML model or voice-synthesis system.
      </p>
      ...
      <ol>
        <li>
          <strong>Billing.</strong> You authorise the Store to charge your designated payment method
          the Subscription fee (plus any applicable taxes) at the start of each billing period.
        </li>
        <li>
        ...
        <li>
          <strong>How to cancel.</strong> Cancel via your Store's subscription management (Apple ID
          → Subscriptions → HEAL → Cancel, or Google Play → Subscriptions → HEAL → Cancel) at least
          24 hours before the next billing date.
        </li>
        <li>
          <strong>No mid-period cancellation.</strong> Once a billing period begins, you continue to
          have access until the period ends and will not receive a pro-rated refund except where
          required by law.
        </li>
        <li>
          <strong>Price changes.</strong> We may change Subscription fees at any time. Price changes
          will not affect the then-current billing period.
        </li>
        <li>
        ...
        <li>
          <strong>Family Sharing.</strong> Where supported by the Store, family sharing is governed
          by the Store's family-sharing policies.
        </li>
      </ol>
      ...
      <p>
        ...
        and explain why the Service did not meet your reasonable expectations.
      </p>
      ...
      <p>
        Where the change is material and adverse to active Subscribers, we will provide at least 30
        days' notice in advance via in-App notification or email to the address on file.
      </p>
      ...
      <p>
        ...
        with or without cause, including if we reasonably believe that you have breached these
        Terms.
      </p>
      <p>
      ...
      <p>
        <strong>
          ...
          ALL SESSIONS ARE PROVIDED "AS IS" AND "AS AVAILABLE", WITHOUT WARRANTY OF ANY KIND, EITHER
      ...
      <p>
        The Company does not warrant that the Service will meet your requirements, that any session
        will be effective for any particular purpose, that the Service will be uninterrupted,
        timely, secure or error-free, that any errors will be corrected, or that the App or its
      ...
      <ol>
        ...
        <li>
          any loss of profits, revenue, business, goodwill, anticipated savings, data, use, or other
          intangible losses;
        </li>
        <li>
          any damages resulting from (a) your access to or use of (or inability to access or use)
          the Service; (b) any conduct or content of any third party; (c) any content obtained from
          the Service; or (d) unauthorized access or alteration of your transmissions or content;
        </li>
      ...
      <p>
        ...
        limited under applicable law — including liability for fraud, for death or personal injury
        caused by negligence, or for any other liability that cannot be lawfully excluded or
        limited.
      </p>
      ...
      <p>
        ...
        attorneys' fees) arising from your access to or use of the Service, your violation of these
        Terms, or your negligent or wrongful act or omission.
      </p>
      ...
      <p>
        ...
        Singapore International Arbitration Centre (SIAC) under its then-current Arbitration Rules,
        by a single arbitrator. The seat of arbitration will be Singapore. The language of
      ...
      <p>
        ...
        these Terms (excluding the obligation to pay) where caused by an event beyond its reasonable
        control, including acts of God, natural disasters, pandemics, war, terrorism, civil unrest,
        government action, internet or telecommunications failures, power failures, cyberattacks, or
        labour disputes.
      </p>
      ...
      <p>
        ...
        The severed provision will be replaced by a valid provision that most closely reflects the
        original intent.
      </p>
      ...
      <p>
        ...
        and any policies or notices referenced within them, constitute the entire agreement between
        you and the Company with respect to the Service.
      </p>
      ...
      <p>
        For any questions about these Terms, complaints, claims, or copyright-infringement notices,
        contact:
      </p>
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>Under the CCPA/CPRA, see the HEAL Privacy Policy for personal-information handling.</li>
      </ul>

      <h3>30.3 Australia</h3>
      <ul>
        <li>
          Under the Australian Consumer Law, you have rights that cannot be excluded, including the
          guarantee of acceptable quality. Nothing in these Terms is intended to override those
          rights.
        </li>
      </ul>
      ...
      <p>
        ...
        not establish a clinical relationship with a provider in your jurisdiction. If you reside in
        a country that prohibits the use of unlicensed digital mental-health tools, do not use HEAL.
      </p>
      ...
      <p>
        ...
        (irreversibly anonymized) data for research purposes only. We never sell your data. See the{' '}
        <a href="/heal/policy" className="text-coral underline">
          HEAL Privacy Policy
        </a>{' '}
