...
export default function HealPoliciesPage() {
  return (
    <PlainLegalPage
      documentTitle="HEAL — Privacy Policy"
      version={VERSION}
      lastUpdated={LAST_UPDATED}
      otherDoc={{ label: 'HEAL — Terms and Conditions', href: '/heal/tnc' }}
      sections={SECTIONS}
    >
      <h2 id="controller">2. Data Controller & Contact</h2>
      <p>
        For the purposes of applicable data-protection law, the data controller for the Service is:
      </p>
      <ul>
        <li>
        ...
        <li>
          Privacy contact: <a href="mailto:privacy@positiveness.club">privacy@positiveness.club</a>
        </li>
        <li>
      ...
      <p>
        This Policy applies to the HEAL mobile application distributed under the bundle identifiers{' '}
        <code>com.pclub.heal</code> (iOS) and <code>com.pclub.heal</code> (Android) and operated by
        the Company. It does <strong>not</strong> cover:
      </p>
      <ul>
        <li>
        ...
        <li>
          the platform-level privacy policy at <a href="/privacy">/privacy</a>, which covers the
          positiveness.club marketing website;
        </li>
        <li>
      ...
      <ol>
        ...
        <li>
          <strong>In-App receipt validation (Apple only):</strong> when you make a purchase, the App
          performs a local cryptographic check on the receipt returned by the Store. This check
          involves Apple's App Store server but does not transmit your personal data to the Company.
        </li>
        <li>
          <strong>Optional error reports:</strong> if you choose to email us about a problem (for
          example via the in-App "Send feedback" button), we receive whatever you type plus standard
          email metadata.
        </li>
        <li>
          <strong>Email magnet delivery (positiveness.club website, not the App):</strong> if you
          submit the free-audio-pack form on the website, the Company receives your email and stores
          it in PocketBase. See the platform-level privacy policy at <a href="/privacy">/privacy</a>
          .
        </li>
      </ol>
      <p>
        <strong>We do not</strong> collect your name, phone number, email address, mailing address,
        IP address, GPS location, contact list, microphone recordings, photos, health metrics,
        browser fingerprint, or any device-identifying advertising ID.
      </p>
      ...
      <ul>
        ...
        <li>
          no analytics events whatsoever (no Firebase Analytics, Amplitude, Mixpanel, Segment, Heap,
      ...
      <p>
        We do not use any data for profiling, advertising, or sale. The limited data that may be in
        our possession (email magnet signups, support emails) is used solely for:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          <strong>Legitimate interests (Art. 6(1)(f))</strong> — for security, fraud prevention, and
          the limited, non-marketing support communications described in this Policy, where the
          Company's interests are not overridden by your rights and freedoms.
        </li>
        <li>
      ...
      <p>
        ...
        third party. The only parties that ever receive any data related to your use of the App are:
      </p>
      <ol>
        <li>
        ...
        <li>
          <strong>Google LLC</strong> — for Play Store purchase processing and fraud prevention. See
          Google's{' '}
      ...
      <p>
        ...
        emails may be transmitted to and stored on servers located in Singapore, the European Union,
        or the United States — whichever jurisdiction our hosting provider uses at the time.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>Email magnet signups (positiveness.club website):</strong> until you unsubscribe,
          with a maximum of 24 months of inactivity after which the record is anonymized.
        </li>
        <li>
      ...
      <p>
        The Company implements technical and organizational measures appropriate to the risk of the
      ...
      <ul>
        ...
        <li>
          the principle of local-first — most processing happens on the Device, not on our servers;
        </li>
        <li>
          access controls on internal systems, including multi-factor authentication for employees;
        </li>
      ...
      <p>
        ...
        without undue delay and, where feasible, within 72 hours of becoming aware of the breach, in
        accordance with GDPR Article 33–34, the PDPA Notification of Data Breaches regime, and
        similar laws.
      </p>
      <p>
      ...
      <ol>
        ...
        <li>
          <strong>Right to restriction of processing</strong> — request that we limit how we process
          your data.
        </li>
        <li>
        ...
        <li>
          <strong>Right to lodge a complaint with a supervisory authority</strong> — see Section 24.
        </li>
      </ol>
      <p>
      ...
      <p>
        ...
        (13 in most countries, 14 in Indonesia/South Korea, 16 in the EEA / UK / Singapore — see the
        corresponding section of the Terms for the full table). We do not knowingly collect personal
      ...
      <p>
        ...
        <a href="mailto:privacy@positiveness.club">privacy@positiveness.club</a> and we will delete
      ...
      <p>
        The App does <strong>not</strong> collect sensitive health data. However, we recognize that
        the very nature of the Audio Content (anxiety, sleep, overwhelm) means that, in voluntary
        support communications, you may choose to share sensitive information with us. Where you do
        so, you explicitly consent to that processing for the narrow purpose of responding to your
        support request. We will:
      </p>
      <ul>
      ...
      <p>
        The Company is <strong>not a HIPAA covered entity</strong>, and HEAL is not a HIPAA-covered
        service. If you are a U.S. clinician seeking HIPAA-compliant tools, this App is not designed
        for that use.
      </p>
      ...
      <p>
        ...
        decisions about you. Some Audio Content may be generated or post-processed using third-party
        voice-synthesis tools. Where this is the case:
      </p>
      <ul>
      ...
      <p>
        ...
        <strong>none</strong>. If you choose to contact us by email or submit the email-magnet form
        on our website, the categories we may collect are: identifiers (email address) and
      ...
      <p>
        <strong>Business or commercial purposes.</strong> Responding to your inquiry; delivering the
        email magnet you requested.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="mailto:privacy@positiveness.club">privacy@positiveness.club</a> with "CCPA Request"
        in the subject line.
      </p>
      <p>
        <strong>Authorized agent.</strong> You may designate an authorized agent to make a CCPA
        request on your behalf. We will verify the request by contacting you at the email address on
        file.
      </p>
      <p>
      ...
      <p>
        <strong>Shine the Light (Cal. Civ. Code §1798.83).</strong> California residents may request
        information about categories of personal information disclosed to third parties for those
        parties' direct-marketing purposes. We do not disclose personal information to third parties
      ...
      <p>
        ...
        Proteção de Dados (Law 13.709/2018). Data Subjects have the rights described in Articles 18
        and 19 LGPD, including confirmation of the existence of processing, access, correction,
      ...
      <p>
        For Users in Singapore, the Company is subject to the Personal Data Protection Act 2012 (Act
        26 of 2012). We have designated a Data Protection Officer (DPO) who can be contacted at{' '}
        <a href="mailto:dpo@positiveness.club">dpo@positiveness.club</a>. You may also contact the
      ...
      <p>
        For Users in Indonesia, the Company is subject to Undang-Undang Nomor 27 Tahun 2022 tentang
        Pelindungan Data Pribadi. Pelindungan data pribadi subjek data Indonesia diawasi oleh
        Kementerian Komunikasi dan Informatika. Complaints may be submitted to the relevant
        authority via{' '}
      ...
      <p>
        The Company has not sold, shared or otherwise disclosed personal information for monetary or
        other valuable consideration in the preceding 12 months. We do not knowingly sell or share
      ...
      <p>
        We aim to acknowledge privacy inquiries within 5 business days, and to respond substantively
        within 30 days. If your complaint is not resolved to your satisfaction, you may lodge it
        with your local data-protection authority (see Sections 20–25).
      </p>
    </PlainLegalPage>
  )
}
