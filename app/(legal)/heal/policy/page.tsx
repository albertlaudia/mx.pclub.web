...
export default function HealPolicyPage() {
  return (
    <PlainLegalPage
      ...
      otherDoc={{ label: 'HEAL — Terms and Conditions', href: '/heal/terms' }}
      sections={SECTIONS}
    >
      ...
      <ul>
        ...
        <li>
          Data you submit to clinical professionals, therapists, or any health service outside HEAL.
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>App version, device model, OS version, locale.</strong> Reason: deliver a session
        ...
        <li>
          ...
          you have access to Pro-tier sessions. The receipt is delivered by Apple or Google and
      ...
      <p>
        If you opt in to <em>Settings → Privacy → Share listening stats to improve sessions</em>, we
        collect:
      </p>
      <ul>
        <li>
      ...
      <p>
        This data is used only to improve which sessions we recommend and how we pace them. You can
      ...
      <p>
        By default, <strong>everything you do in HEAL stays on your device</strong>. This includes:
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>
          ...
          requested that we share data with a crisis service and we need to share that minimum data
          to protect your life. (See{' '}
          <a href="/heal/terms" className="text-coral underline">
            HEAL Terms §9
          </a>
          .)
        </li>
      ...
      <ul>
        <li>
          <strong>Not using your personal data to train AI models.</strong> Your mood logs, journal
          entries, and listening history are not transmitted to any model provider for training.
        </li>
        <li>
        ...
        <li>
          <strong>Not using audio sessions to clone voices.</strong> You may not use any Content to
          train, fine-tune, evaluate or clone any voice (see{' '}
          <a href="/heal/terms" className="text-coral underline">
            HEAL Terms §11
          </a>
          ).
        ...
        <li>
          <strong>Human editorial control.</strong> Every published session is reviewed and approved
          by a qualified human editor (with clinical or scientific credentials) before release.
        </li>
      </ul>
