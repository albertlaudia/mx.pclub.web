...
export default function RiseupTermsPage() {
  return (
    <PlainLegalPage
      documentTitle="Riseup — Terms and Conditions"
      version={VERSION}
      lastUpdated={LAST_UPDATED}
      otherDoc={{ label: 'Riseup — Privacy Policy', href: '/riseup/policy' }}
      sections={SECTIONS}
    >
      ...
      <p>
        ...
        Riseup mobile application (the <strong>"App"</strong> or <strong>"Riseup"</strong>).
      </p>
      <p>
        By downloading, installing, accessing or using Riseup — including any of its morning routine
        prompts, habit tracking, journal entries, or related services made available by the Company
      ...
      <p>
        Riseup is intended as a <strong>self-coaching and accountability tool</strong> for generally
        healthy adults. It is <strong>not</strong> medical treatment, mental-health care,
        professional coaching, or any other professional service.
      </p>
      <p>
      ...
      <ol>
        <li>
          <strong>Free Tier</strong> — A fixed number of free routines and habit slots (for example,
          three routines and three habits), which may be revised at our discretion.
        </li>
        <li>
          <strong>Pro Tier</strong> — A paid Subscription (see §11) that grants unlimited routines,
          unlimited habits, full access to the audio library, and offline downloads.
        </li>
      </ol>
      <p>
      ...
      <p>
        The Service, the App, the audio Content, the transcripts, the brand, and the trade dress are
        and will remain the exclusive property of the Company and our licensors (including voice
        talent, script writers, and music licensors). No rights are granted to you except the
      ...
      <p>
        ...
        <strong>You may not</strong> use any Riseup audio to train, fine-tune, evaluate, or clone
      ...
      <p>
        ...
        §28 and explain why the Service did not meet your reasonable expectations.
      </p>
      ...
      <p>
        <strong>
          ...
          ALL AUDIO SESSIONS ARE PROVIDED "AS IS" AND "AS AVAILABLE", WITHOUT WARRANTY OF ANY KIND,
      ...
      <p>
        <strong>
          ...
          AFFILIATES, DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, CONTRACTORS, LICENSORS, COACHES, VOICE
          TALENT OR SUPPLIERS BE LIABLE TO YOU OR TO ANY THIRD PARTY FOR ANY INDIRECT, INCIDENTAL,
          CONSEQUENTIAL, SPECIAL, EXEMPLARY OR PUNITIVE DAMAGES; ANY LOSS OF PROFITS, REVENUE,
          BUSINESS, GOODWILL, ANTICIPATED SAVINGS, DATA, USE, OR OTHER INTANGIBLE LOSSES; OR ANY
      ...
      <p>
        ...
        <a href="/riseup/policy" className="text-coral underline">
